...
otroContador()      // 2 */
function counter() {
  let contador = 0// inicia en 0
  return function () {
    contador++// incrementa 1 en 1
    return contador
  }
}
const nuevoContador = counter()
...
let textoAsteriscos = crearCadena.bind(crearCadena, "*", "*", "Hola");
console.log(textoAsteriscos());
let textoGuiones = crearCadena.bind(crearCadena, "-", "-", "Hola");
console.log(textoGuiones());
let textoUnderscore = crearCadena.bind(crearCadena, "_", "_", "Hola");
